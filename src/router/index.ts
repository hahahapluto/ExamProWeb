    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "题目题库终极审核",
          component: () =>
            import("../component/audit/ultimate/bankQuesUltimate.vue"),
        },
        {
          path: "/index/aduit/ultimate/examUtlimate",
          name: "考试终极审核",
          component: () =>
            import("../component/audit/ultimate/examUtlimate.vue"),
        },
        {
          path: "/index/aduit/ultimate/paperUltimate",
          name: "试卷终极审核",
          component: () =>
            import("../component/audit/ultimate/paperUltimate.vue"),
        },
        {
        ...
        {
          path: "/index/enterExamUltimate",
          name: "查看考试",
          component: () => import("../component/exam/examPaperUltimate.vue"),
        },
        {
        ...
        },
        {
          ...
          name: "监考聊天框",
          component: () =>
            import("../component/invigilate/InvigilationChat.vue"),
        },
        {
