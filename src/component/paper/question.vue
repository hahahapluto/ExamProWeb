  ...
  <div>
    ...
    <div class="selector">
      <el-form :model="form" class="selector-form" size="large">
        ...
        <el-row class="mb-4">
          <el-button type="primary" color="#626aef" icon="plus" @click="dialogFormVisible = true"> 新增题目 </el-button>
    ...
    <el-dialog v-model="dialogFormVisible" title="新增题目">
      <el-form :model="dialogForm">
        ...
        <!-- 主观题 -->
        <el-form-item label="题目内容" :label-width="formLabelWidth" v-if="dialogForm.qtype == 1">
          <el-input v-model="dialogForm.describe" autocomplete="off" :autosize="{ minRows: 7, maxRows: 7 }" type="textarea" placeholder="请输入题目内容" maxlength="500" show-word-limit />
        </el-form-item>
        <el-form-item label="题目答案" :label-width="formLabelWidth" v-if="dialogForm.qtype == 1">
          <el-input v-model="dialogForm.answer" autocomplete="off" type="textarea" placeholder="请输入题目答案" maxlength="500" show-word-limit :autosize="{ minRows: 7, maxRows: 7 }" />
        </el-form-item>
        <!-- 单选题 -->
        <el-form-item label="题目描述" :label-width="formLabelWidth" v-if="dialogForm.qtype == 2 || dialogForm.qtype == 3">
          <el-input v-model="dialogForm.describe" autocomplete="off" :autosize="{ minRows: 3, maxRows: 3 }" type="textarea" placeholder="请输入题目内容" maxlength="200" show-word-limit />
        </el-form-item>
        <el-form-item label=" 选项A " class="choose" v-if="dialogForm.qtype == 2 || dialogForm.qtype == 3">
          <el-input v-model="dialogForm.choose.A" />
        </el-form-item>
        <el-form-item label=" 选项B " class="choose" v-if="dialogForm.qtype == 2 || dialogForm.qtype == 3">
          <el-input v-model="dialogForm.choose.B" />
        </el-form-item>
        <el-form-item label=" 选项C " class="choose" v-if="dialogForm.qtype == 2 || dialogForm.qtype == 3">
          <el-input v-model="dialogForm.choose.C" />
        </el-form-item>
        <el-form-item label=" 选项D " class="choose" v-if="dialogForm.qtype == 2 || dialogForm.qtype == 3">
          <el-input v-model="dialogForm.choose.D" />
        </el-form-item>
        <el-form-item label="单选答案" v-if="dialogForm.qtype == 2" class="single">
        ...
        <!-- 多选题 -->
        <el-form-item label="多选答案" v-if="dialogForm.qtype == 3" class="single">
